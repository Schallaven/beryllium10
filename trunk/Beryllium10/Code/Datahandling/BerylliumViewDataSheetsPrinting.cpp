...
CBerylliumViewDataSheetsPrinting::CBerylliumViewDataSheetsPrinting( CBerylliumViewDataSheets &view, CBerylliumDocument &document ) : m_view(view), m_document(document), wxPrintout( document.GetFilename() )
{
}
